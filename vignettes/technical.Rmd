...
For small samples, the choice of degrees of freedom will potentially influence the accuracy of the power analysis a lot. In **powerlmm** it is therfore possible to use Satterthwaite's DF approximation in the power analysis. The degrees of freedom of the *t* distribution is approximated as,
