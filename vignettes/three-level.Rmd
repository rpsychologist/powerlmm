...
For standardized effect sizes that use either the pretest or posttest SD, then the effect size refers to the standardized difference between the groups at posttest,
...
If the random slope SD is used as the standardizer, the ES now indicate the difference per unit of time, 
